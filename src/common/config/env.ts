...
export const DATABASE_PORT = process.env.DATABASE_PORT ? +process.env.DATABASE_PORT : 0;
...
export const SALT_ROUNDS = process.env.SALT_ROUNDS ? +process.env.SALT_ROUNDS : 0;
